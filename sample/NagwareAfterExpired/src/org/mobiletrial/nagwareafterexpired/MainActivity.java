package org.mobiletrial.nagwareafterexpired;
...
public class MainActivity extends Activity {
	...
	private class MyLicenseCheckerCallback implements LicenseCheckerCallback {
		...
		public void dontAllow(int policyReason) {
			...
			// Should allow access but behave like a nagware. In most cases, the app should assume
			// the user has access unless it encounters this. If it does,
			// the app should inform the user of their unlicensed ways
			// and then either shut down the app or limit the user to a
			// restricted set of features or like in this case behave like a nagware.
			// In this example, we show a dialog that takes the user to Market or continues the app.
			...
			if(policyReason == Policy.RETRY){
				mHandler.post(new Runnable() {
					public void run() {
						...
						dlg.setBody(mRes.getString(R.string.retry));
						dlg.setNegativeButton(mRes.getString(R.string.continue_app), new OnClickListener() {
							@Override
				...
				mHandler.post(new Runnable() {
					public void run() {
						...
						dlg.setBody(mRes.getString(R.string.notlicensed));
						dlg.setNegativeButton(mRes.getString(R.string.continue_app), new OnClickListener() {			
							@Override
							public void onClick(DialogInterface dialog, int which) {
